...
local armorTexturePath2 = "%s:textures/models/armor/%s_layer_%s.png"
    ...
    for _, instance in ipairs(instances) do
      ...
      if trim then
        ...
        elseif client.getAtlas(armorTrimAtlasPath) then
          ...
          local spriteData = atlas:getSpriteUV(armorTrimSpritePath:format(trimNamespace, atlasPattern,
            atlasMaterial))
